...
class SecondPartIhtiyariDetailsFragmentViewModel : ViewModel() {
    ...
    fun setExplanation(userInput : Double, selection1 : Int,  selection2 : Int, selection3: Int, selection4: Int ): String{
        ...
        when(selection3){
            0-> caseType = "Aile Hukuku Uyuşmazlığında, "
            1-> caseType = "Ticari Uyuşmazlıkta, "
            2-> caseType = "İş Hukuku Uyuşmazlığında, "
            3-> caseType = "Tüketici Uyuşmazlığında, "
            4-> caseType = "Diğer Tür Uyuşmazlığında, "
        }
        when(selection4){
